...
namespace BookStoreApplication.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            UserManager<BookStoreApplicationUser> userManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new BookStoreApplicationUser { UserName = Input.Email, Email = Input.Email };
